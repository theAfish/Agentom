...
# Adjust paths for atom_coding structure
...
@ai_function(name="generate_structure_image", description="Generates an image of the structure using ASE.")
...
@ai_function(name="run_python_script", description="Runs a Python script in the workspace.")
